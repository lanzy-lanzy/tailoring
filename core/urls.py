...
urlpatterns = [
    ...
    path('inventory/fabrics/<int:pk>/add-stock/', views.fabric_add_stock, name='fabric_add_stock'),
    path('inventory/fabrics/<int:pk>/delete/', views.fabric_delete, name='fabric_delete'),
    
    # Accessory
    path('inventory/accessories/', views.accessory_list, name='accessory_list'),
    path('inventory/accessories/create/', views.accessory_create, name='accessory_create'),
    path('inventory/accessories/<int:pk>/edit/', views.accessory_edit, name='accessory_edit'),
    path('inventory/accessories/<int:pk>/add-stock/', views.accessory_add_stock, name='accessory_add_stock'),
    path('inventory/accessories/<int:pk>/delete/', views.accessory_delete, name='accessory_delete'),
    ...
    path('garments/<int:pk>/delete/', views.garment_type_delete, name='garment_type_delete'),
    path('garments/<int:pk>/add-accessory/', views.garment_type_add_accessory, name='garment_type_add_accessory'),
    path('garments/<int:pk>/remove-accessory/<int:accessory_pk>/', views.garment_type_remove_accessory, name='garment_type_remove_accessory'),
    ...
    path('payments/<int:payment_pk>/receipt/', views.receipt_print, name='receipt_print'),
